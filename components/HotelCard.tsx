    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-2 mb-1">
          <h3 className="font-playfair font-semibold text-ocean-900 text-lg leading-tight">
            {hotel.name}
          </h3>
        </div>
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {hotel.amenities.slice(0, 3).map((amenity) => (
            <span
              key={amenity}
              className="text-xs bg-ocean-50 text-ocean-600 px-2 py-0.5 rounded-full flex items-center gap-1"
            >
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          ...
          <Link
            href="/contact"
            className="bg-ocean-500 text-white text-sm font-semibold px-4 py-2.5 rounded-full hover:bg-ocean-600 transition-colors active:scale-95"
          >
            Réserver
          </Link>
        </div>
